window.addEventListener("load", (e) => {
    ...
    const AP1_KEY = "e7a3294162d66c7228caaf499a8a09fc"
    ...
    const getLocationCoordinates = () => {
        ...
        if (!cityName || !countryCode) return alert("put in city && country")
        
 
        const GEO_URL = `http://api.openweathermap.org/geo/1.0/direct?q=${cityName}&limit=1&appid=${AP1_KEY}`
